...
import { styles } from '../components/energyTechWeekly/issue/styles/styles'
import EnergyTechAltStoryContainer from '../components/energyTechWeekly/altStory/EnergyTechAltStoryContainer'
    ...
    render() {
        return (
            ...
            <View style={styles.storyWrapper}>
                ...
                <Text style={styles.by}>By <Text style={styles.author}>John Gibson</Text></Text>
